    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-400 mt-2">Start your JEE journey today</p>
        </div>
        ...
        <div className="bg-neutral-900/80 backdrop-blur-xl border border-neutral-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex gap-3 mb-6">
            ...
            >
              ...
              <div className="text-xs opacity-70">Preparing for JEE</div>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <div className="text-xs opacity-70">IIT/NIT Student</div>
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-neutral-800/50 border border-neutral-700 rounded-lg pl-11 pr-4 py-3 text-white placeholder-neutral-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-medium py-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
            >
              {isLoading ? (
