...
export function BackgroundRippleEffect() {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 overflow-hidden bg-black flex flex-wrap content-start"
        style={{
          zIndex: 0,
        }}
      >
        {gridBlocks.map((_, i) => (
          <motion.div
            ...
            className="border-[0.5px] border-neutral-900 flex-shrink-0 relative group"
            whileHover={{
              scale: 1.15,
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle at 50% 50%, transparent, rgba(0,0,0,0.4) 80%)',
            zIndex: 60
          }}
        />
      </div>
